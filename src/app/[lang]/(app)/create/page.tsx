...
export default function page() {
  return (
    <form id="create-post" className="mt-4 max-w-md mx-auto" >
      <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        <UserCardHeader/>
        <div className="px-4 py-2 bg-white dark:bg-gray-800">
          <div className="mb-2 " >
            <input type="text" name="title" id="title" className="px-3 py-1.5 bg-gray-50 dark:bg-gray-700 placeholder:text-disabled text-sm background-transparent rounded border border-disabled" placeholder="Title" />
          </div>
          <div>
            <label htmlFor="comment" className="sr-only">Your comment</label>
            <textarea id="comment" rows={4} className="w-full px-3 py-1.5 text-sm text-gray-900 rounded border border-disabled bg-white dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write a post..." required></textarea>
          </div>
        </div>
