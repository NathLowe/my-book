...
export default function Drawer() {
  return (
    <div id={drawerId} className="fixed top-0 left-0 z-60 shadow h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80
        ...
        <button type="button" data-drawer-hide={drawerId} aria-controls={drawerId} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
